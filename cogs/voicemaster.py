...
unlockemoji = "<:unlock:1083458773244457080>"
lockemoji = "<:lock:1083457584142487572>"
plusemoji = "<:plus:1083457506350739456>"
minusemoji = "<:minus:1083457544682471475>"
channelemoji = "<:channel:1083457459215142982>"
unghostemoji = "<:unghost:1048166159918313482>"
ghostemoji = "<:ghost:1048166145301168158>"
claimemoji = "<:claim:1083457326108917841>"
hammeremoji = "<:hammer:1083457414130569286>"
manemoji = "<:man:1083457237487452252>" 
...
class voicemaster(commands.Cog):
   ...
   def create_interface(self, ctx: commands.Context) -> discord.Embed: 
     ...
     em.add_field(name="Manage", value=f"{lockemoji} [`lock`](https://discord.gg/pretend) the voice channel\n{unlockemoji} [`unlock`](https://discord.gg/pretend) the voice channel\n{ghostemoji} [`hide`](https://discord.gg/pretend) the voice channel\n{unghostemoji} [`reveal`](https://discord.gg/pretend) the voice channel\n{channelemoji} [`rename`](https://discord.gg/pretend) the voice channel")
     em.add_field(name="Misc", value=f"{plusemoji} [`increase`](https://discord.gg/pretend) the user limit\n{minusemoji} [`decrease`](https://discord.gg/pretend) the user limit\n{claimemoji} [`claim`](https://discord.gg/pretend) the voice channel\n{manemoji} [`info`](https://discord.gg/pretend) of the channel\n{hammeremoji} [`moderate`](https://discord.gg/pretend) the voice channel")    
     return em
